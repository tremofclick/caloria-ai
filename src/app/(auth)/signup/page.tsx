...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    // Salvar dados temporários e ir para onboarding
    sessionStorage.setItem('signup-data', JSON.stringify({ name, email, password }));
    router.push('/onboarding');
  };

  const handleSocialSignUp = (provider: string) => {
    alert(`Cadastro com ${provider} será implementado em breve!`);
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 space-y-6">
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white rounded-xl text-lg font-semibold"
              disabled={loading}
            >
